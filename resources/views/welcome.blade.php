<x-layout title="Welcome">
    <div class="grid items-center gap-12 py-8 lg:grid-cols-2 lg:py-16">
        <div>
            <p class="text-brand mb-5 font-mono text-xs tracking-widest uppercase">Your personal practice workspace</p>
            <h1 class="text-5xl leading-tight font-semibold tracking-tight sm:text-6xl">
                Small tasks.<br />A working start.
            </h1>
            <p class="mt-6 max-w-md text-lg leading-relaxed text-slate-500">
                Keep your next steps in one place. Track what’s in progress, finish what matters, and take your task
                history with you.
            </p>
        ...
        <x-card class="relative overflow-hidden">
            <div class="bg-brand absolute inset-y-0 left-0 w-1"></div>
            <p class="font-mono text-xs tracking-widest text-slate-400 uppercase">A place to make progress</p>
